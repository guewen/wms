...
class ResConfigSettings(models.TransientModel):
    ...
    module_stock_putaway_rule = fields.Boolean(string="Configurable Put-Away Rules")
    module_stock_putaway_recursive = fields.Boolean(string="Recursive Put-Away rules")
    module_stock_putaway_abc = fields.Boolean(string="ABC chaotic storage Put-Away")
